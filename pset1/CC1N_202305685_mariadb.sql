...
-- CASO JÁ EXISTA O BANCO DE DADOS 'uvv' EXCLUIR
DROP DATABASE IF EXISTS uvv;

-- CASO JÁ EXISTA O USUÁRIO 'joaodellarmelina' EXCLUIR 
DROP USER IF EXISTS 'joaodellarmelina'@'localhost'; 

-- CRIAR USUÁRIO 'joaodellarmelina' COM O HOST 'localhost'
CREATE USER 'joaodellarmelina'@'localhost' IDENTIFIED BY '12345678';

-- PASSANDO TODOS OS PRIVILEGIOS PARA O USUARIO 'joaodellarmelina'
GRANT ALL PRIVILEGES ON *.* to 'joaodellarmelina'@'localhost';
FLUSH PRIVILEGES;
...
-- COMENTARIOS DA TABELA E COLUNAS DE PRODUTOS 
...
'Preço da unidade de cada produto.';
...
'Parâmetro de codificação de caracteres.';
ALTER TABLE produtos MODIFY COLUMN imagem_ultima_atualizao DATE COMMENT 
'Data da ultima atualização da imagem do produto.';
...
-- COMENTARIOS DA TABELA E COLUNAS DE LOJAS 
...
-- COMENTARIOS DA TABELA E COLUNAS DE ESTOQUES
...
-- COMENTARIOS DA TABELA E COLUNAS DE CLIENTES
...
-- COMENTARIOS DA TABELA E COLUNAS DE ENVIOS
...
-- PASSANDO UMA VERIFICAÇÃO DE DADOS PARA 'STATUS'
ALTER TABLE     envios
ADD CONSTRAINT  informe_status_válido
...
-- COMENTARIOS DA TABELA E COLUNAS DE PEDIDOS
...
-- COMENTARIOS DA TABELA E COLUNAS DE pedidos_itens
...
-- ALTERAÇÃO DE TABELAS E DEFINÇÕES DE FK 
